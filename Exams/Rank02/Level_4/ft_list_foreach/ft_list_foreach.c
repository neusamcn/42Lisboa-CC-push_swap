...
//     t_list *node1 = create_node(strdup("Hello"));
//     t_list *node2 = create_node(strdup("World"));
//     t_list *node3 = create_node(strdup("!"));
...
//     t_list  *node4 = create_node(a);
//     t_list  *node5 = create_node(b);
//     t_list  *node6 = create_node(c);
